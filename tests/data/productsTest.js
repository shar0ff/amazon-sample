...
describe('Test suite: Product', () => {
  ...
  it('Product has the correct properties', () => {
  ...
  it('Product has the correct stars url', () => {
    expect(product.getStarsUrl()).toEqual('images/ratings/rating-45.png');
  });

  it('Product has the correct price', () => {
...
describe('Test suite: Clothing', () => {
  ...
  it('Clothing has the correct stars url', () => {
    expect(clothing.getStarsUrl()).toEqual('images/ratings/rating-45.png');
  });

  it('Clothing has the correct price', () => {
...
describe('Test suite: Appliance', () => {
  ...
  it('Appliance has the correct properties', () => {
  ...
  it('Appliance has the correct stars url', () => {
    expect(appliance.getStarsUrl()).toEqual('images/ratings/rating-50.png');
  });

  it('Appliance has the correct price', () => {
